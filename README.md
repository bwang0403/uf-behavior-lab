...
Experimenter panel shows "LOADING WHISPER MODEL..."
    ...
    -> Experimenter clicks CONTINUE when participant is ready
    -> Practice round begins (if enabled in config)
    -> Phase 1 begins (arc countdown visible on participant screen)
...
| Instruction text (full screen) | Read instructions; experimenter will dismiss |
